...
Files: macbook-16.glb [639.28KB] > C:\Users\Dan\Documents\FRONTEND\macbook_gsap_app\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
export default function MacbookModel16(props) {
  ...
  useEffect(() => {
    scene.traverse((child) => {
      if (child.isMesh) {
        // Change the color only if the part name is NOT noChangeParts
